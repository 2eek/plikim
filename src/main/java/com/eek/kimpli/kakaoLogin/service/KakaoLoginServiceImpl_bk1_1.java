...
//public class KakaoLoginServiceImpl_bk1_1 implements KakaoLoginService {
//
...
////         userInfo.put("id", id);
//          userInfo.put("id", email.substring(0, email.indexOf('@')));
//         System.out.println("아이디체크"+userInfo.put("id", email.substring(0, email.indexOf('@'))));
