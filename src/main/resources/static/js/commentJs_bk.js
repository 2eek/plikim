        ...
        const loadComments = (page = 0, size = 10) => {
            ...
            $.ajax({
                ...
                success: function (commentsPage) {
                    // 댓글 목록을 화면에 표시 commentList ->이걸 댓글리스트의 컨테이너로 쓴다
...
// 10)페이지 로딩 완료 후 초기 댓글 목록 및 페이징 버튼 생성
...
function attachCommentEventListeners() {
  ...
  $(document).on('click', '.open-reply-form-button', function () {
      console.log('hello');
